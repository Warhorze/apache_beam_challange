...
def main(argv=None, save_main_session=True):
    ...
    pipeline_args.extend([
        ...
        f'--staging_location=gs://{known_args.bucket}/staging',
         f'--setup_file=/home/ron/Documents/projects/ml6_challange/src/setup.py'#tried to set-up on gcp stroage
    ])
    ...
    with beam.Pipeline(options=pipeline_options) as pipeline:
        ...
        total_rides | 'WriteToGCS' >> WriteToText(known_args.output, file_name_suffix=".txt")
